                    ...
                    <div
                        ...
                        <div class="bg-white px-6 py-6 sm:px-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="mb-4">
                                    <h4 class="font-bold text-gray-700 mb-1">Información General</h4>
                                    <ul class="list-disc list-inside space-y-2">
                                        ...
                                        @if (in_array('monitor', $this->atributosVisibles))
                                        ...
                                        @endif
                                        @if (in_array('mouse', $this->atributosVisibles))
                                        ...
                                        @endif
                                        @if (in_array('teclado', $this->atributosVisibles))
                                        ...
                                        @endif
                                        @if (in_array('version_procesador', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>Versión Procesador:</strong>
                                            <x-input name="version_procesador" class="bg-white"
                                                wire:model="version_procesador" />
                                        </li>
                                        @endif
                                ...
                                <div class="mb-4">
                                    <h4 class="font-bold text-gray-700 mb-1">Atributos</h4>
                                    <ul class="list-disc list-inside space-y-2">
                                        <li class="flex justify-start items-center">
                                            <strong>Dispositivo:</strong>{{ $dispositivo }}
                                        </li>
                                        @if(in_array('almacenamiento', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>Almacenamiento:</strong>
                                            <x-select name="almacenamiento" id="almacenamiento" class="bg-white"
                                                wire:model="almacenamiento">
                                        ...
                                        @if(in_array('memoria', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>RAM:</strong>
                                            <x-select name="ram" id="ram" class="bg-white"
                                                wire:model="memoria">
                                                <option value="">SELECCIONE UNA OPCIÓN</option>
                                        ...
                                        @if(in_array('office', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>Office:</strong>
                                            <x-select name="office" id="office" class="bg-white"
                                                wire:model="office">
                                                <option value="">SELECCIONE UNA OPCIÓN</option>
                                        ...
                                        @if(in_array('procesador', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>Procesador:</strong>
                                            <x-select name="procesador" id="procesador" class="bg-white"
                                        ...
                                        @if(in_array('sistema_operativo', $this->atributosVisibles))
                                        <li class="flex justify-start items-center"><strong>Sistema Operativo:</strong>
                                            <x-select name="sistema" id="sistema" class="bg-white"
                                                wire:model="sistema_operativo">
                                                <option value="">SELECCIONE UNA OPCIÓN</option>
                                        ...
                                        @endif
                                        @if (in_array('flash', $this->atributosVisibles))
                                            <li class="flex justify-start items-center"><strong>Unidad Flash:</strong>
                                                <x-input name="flash" class="bg-white"
                                                    wire:model="flash" />
                                            </li>
                                        @endif
                                    </ul>
