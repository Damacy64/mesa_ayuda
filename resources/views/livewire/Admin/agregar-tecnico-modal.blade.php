                        ...
                        <div class="mt-5 px-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3 mb-4">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="50" id="name" class="block mt-1 w-full" type="text"
                                        name="name" wire:model="name" :value="old('name')" required autofocus
                                        autocomplete="name" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="50" id="last_name_p" class="block mt-1 w-full" type="text"
                                        name="last_name_p" wire:model="last_name_p" :value="old('last_name_p')" required autofocus
                                        autocomplete="last_name_p" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="50" id="last_name_m" class="block mt-1 w-full" type="text"
                                        name="last_name_m" wire:model="last_name_m" :value="old('last_name_m')" required autofocus
                                        autocomplete="last_name_m" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <x-select id="sex" class="block mt-1 w-full bg-afac-gray border rounded-lg"
                                    type="text" name="sex" wire:model="sex" :value="old('sex')" required autofocus
                                    autocomplete="sex">
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="7" id="employer_number" class="block mt-1 w-full"
                                        type="text" name="employer_number" wire:model="employer_number"
                                        :value="old('employer_number')" required autofocus autocomplete="employer_number" />
                                </div>
                            </div>
                            <div class="sm:col-span-1">
                                <div class="sm:col-span-1 flex justify-items-between space-x-10">
                                    <x-label for="entrada" value="{{ __('Hora de Entrada*') }}" />
                                    <x-label for="salida" value="{{ __('Hora de Salida*') }}" />
                                </div>
                                <div class=" sm:col-span-1 flex justify-items-between space-x-12">
                                    <x-input id="entrada" class="block w-1" type="time" name="entrada"
                                        wire:model="entrada" :value="old('entrada')" required autofocus
                                        autocomplete="entrada" />
                                    <x-input id="salida" class="block w-1" type="time" name="salida"
                                        wire:model="salida" :value="old('salida')" required autofocus
                                        autocomplete="salida" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input minlength="8" maxlength="15" id="password" class="block mt-1 w-full"
                                        type="password" name="password" wire:model="password" required
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="35" id="email" class="block mt-1 w-full" type="email"
                                        name="email" wire:model="email" :value="old('email')" required
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="mt-2">
                                    <x-input maxlength="35" id="email_confirmation" class="block mt-1 w-full"
                                        type="email" name="email_confirmation" wire:model="email_confirmation"
                            ...
                            <div class="col-start-1 col-end-4 mb-4">
                                <div class="bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3"
                                    ...
                                    <p class="text-sm">INTRODUCE UNA CONTRASEÑA PARA ESTE SISTEMA. RECUERDA QUE DEBE
                                        TENER AL MENOS 8
                                        CARACTERES,INCLUYENDO AL MENOS UNA MAYÚSCULA, UNA MINÚSCULA, UN NÚMERO Y UN
                                        CARÁCTER ESPECIAL (#, *,
                                        !, @, $, %).</p>
                                </div>
                            </div>
