    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mt-4">
                ...
                <x-input minlength="8" maxlength="15" id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
            </div>

            <div class="mt-4">
                <x-label for="password_confirmation">Confirmación de la Contraseña Nueva</x-label>
                <x-input minlength="8" maxlength="15" id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" />
            </div>
