            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-2">
                        <x-label for="names" value="{{ __('Nombre(s)*') }}" />
                        <div class="mt-2">
                            <x-input maxlength="50" id="names" class="block mt-1 w-full" type="text"
                                name="names" :value="old('names')" required autofocus autocomplete="names" />
                        </div>
                    </div>
